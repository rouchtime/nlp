...
public class CiLinWordSimiarity implements WordSimiarity{
	private Logger logger = Logger.getLogger(CiLinWordSimiarity.class);
	...
	public static CiLinWordSimiarity getInstance() {
		return SingletonHolder.instance;
	}

	private static class SingletonHolder {
		private static final CiLinWordSimiarity instance = new CiLinWordSimiarity();
	}
	...
	public void initCiLin() {
		...
		try {
			...
			inFile = new BufferedReader(new InputStreamReader(
					CiLinWordSimiarity.class.getClassLoader().getResourceAsStream("cilin/keyWord_Identifier_HashMap.txt"),
					"utf-8"));// 读取文本
			...
			inFile.close();
			inFile = new BufferedReader(new InputStreamReader(
					CiLinWordSimiarity.class.getClassLoader().getResourceAsStream("cilin/first_KeyWord_Depth_HashMap.txt"),
					"utf-8"));// 读取文本
			while ((str = inFile.readLine()) != null) {
				strs = str.split(" ");
			...
			inFile.close();
			inFile = new BufferedReader(new InputStreamReader(
					CiLinWordSimiarity.class.getClassLoader().getResourceAsStream("cilin/second_KeyWord_Depth_HashMap.txt"),
					"utf-8"));// 读取文本
			while ((str = inFile.readLine()) != null) {
				strs = str.split(" ");
			...
			inFile.close();
			inFile = new BufferedReader(new InputStreamReader(
					CiLinWordSimiarity.class.getClassLoader().getResourceAsStream("cilin/third_KeyWord_Depth_HashMap.txt"),
					"utf-8"));// 读取文本
			while ((str = inFile.readLine()) != null) {
				strs = str.split(" ");
			...
			inFile.close();
			inFile = new BufferedReader(new InputStreamReader(
					CiLinWordSimiarity.class.getClassLoader().getResourceAsStream("cilin/fourth_KeyWord_Depth_HashMap.txt"),
					"utf-8"));// 读取文本
			while ((str = inFile.readLine()) != null) {
				strs = str.split(" ");
