...
public class TextRankWithMultiWin {
	 ...
	 * 
	 * @param sysKeywordNum(int):
	 *            number of keywords to extractt
	 */
	...
	/**
	 * integrate the results of TextRank algorithm with different co-occurance
	 * window
	 * 
	 * @param title(String):
	 ...
	 * @param minWindow(int):
	 *            the minimum size of co-occurance window
	 * @param maxWindow(int):
	 *            the maximum size of co-occurance window
	 * @return(List<String>): keywords of the document
	 */
	public static List<String> integrateMultiWindow(List<String> tokens, int minWindow, int maxWindow) {
