package com.rouchtime.nlp.keyword.lexicalChain;
...
public class LexicalChainMaxTF {
	...
	public void add(String word) throws Exception {
		if (chainsList.size() != representWordList.size()) {
			throw new Exception("chainsList size is not equal representWordList size");
		}
	...
	public static void main(String[] args) {
		...
		System.out.println(CiLinWordSimilarity.getInstance().calTowWordSimiarity("清洁工", "勤杂人员"));
		LexicalChainMaxTF lctf = new LexicalChainMaxTF(0.9, CiLinWordSimilarity.getInstance(), tfMap);
