...
public class KeywordTest {
	...
	private static TokenizerFactory getTokenFactory() {
		StopWordTokenierFactory stopWordFactory = new StopWordTokenierFactory(AnsjTokenizerFactory.getIstance());
...
//		LexicalChain chain = new LexicalChain(0.6,Word2VectorWordSimiarity.getInstance());
...
//			System.out.println(String.format("%.5f,%s,%s", score.score(),score.getObject().getWord(),score.getObject().getNature()));
//		}
	}
}
