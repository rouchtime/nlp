...
public class DupKWUtils {
	private Map<String, List<Doc>> map = new HashMap<String, List<Doc>>();

	public void add(String newskey, String doc) {
	...
	public Set<String> select(String doc) {
		List<String> keywords = HanLP.extractKeyword(doc, 30);
		if (keywords.size() <= 7) {
			System.out.println("keywords size less 7!");
			return null;
	...
	public double jaccardIndex(final Set<String> s1, final Set<String> s2) {
